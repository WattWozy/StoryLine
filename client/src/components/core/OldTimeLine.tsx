...
const OldTimeline: React.FC<TimelineProps> = ({ from, to }) => {
  ...
  return (
    <div className="relative top-10 text-nowrap text-clip flex max-w-full h-full justify-centerx">
      {yearsToDisplay.map((year, i) => (
